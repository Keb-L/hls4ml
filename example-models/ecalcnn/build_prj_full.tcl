...
set_top myproject_block_layer
add_files firmware/myproject_full_layer.cpp -cflags "-std=c++0x"
add_files -tb myproject_test_full_layer.cpp -cflags "-std=c++0x"
add_files -tb firmware/weights
add_files -tb tb_data
if {$opt(reset)} {
  open_solution -reset "solution_cnn1"
} else {
  open_solution "solution_cnn1"
}
...
if {$opt(cosim)} {
  ...
  add_files -tb myproject_test_full_layer.cpp -cflags "-std=c++0x -DRTL_SIM"
  set time_start [clock clicks -milliseconds]
