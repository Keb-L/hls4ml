...
set_top myproject_cnn_layer
add_files firmware/myproject_cnn_layer.cpp -cflags "-std=c++0x"
add_files -tb myproject_test_cnn_layer.cpp -cflags "-std=c++0x"
...
if {$opt(cosim)} {
  ...
  add_files -tb myproject_test_cnn_layer.cpp -cflags "-std=c++0x -DRTL_SIM"
  set time_start [clock clicks -milliseconds]
