...
def keras_to_hls(yamlConfig):
    ...
    optimizers = ['fuse_conv','fuse_conv2','fuse_merge','eliminate_linear_activation', 'merge_batch_norm_quantized_tanh', 'quantize_dense_output', 'insert_copy_layer', 'conv2d_same_pad']#, 'fuse_dense_batch_norm']
